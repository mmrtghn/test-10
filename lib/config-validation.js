...
const MAX_ANIMAL_UPLOADS = MAX_UPLOAD_FILES - 1;
...
export function validateCommunityConfiguration(communities) {
  ...
  for (const [id, c] of Object.entries(communities)) {
    ...
    if (Object.prototype.hasOwnProperty.call(c, "active") && typeof c.active !== "boolean") errors.push(`${prefix} active must be a boolean.`);
    ...
    validateUpload(c.allowedUploads?.animal, new Set([".png", ".jpg", ".jpeg", ".webp"]), `${prefix} animal`, errors);
